...
admin = User.new(email: "rickytrevi@gmail.com", password: "password", password_confirmation: "password", admin: true, developer: true, employer: true)
admin.skip_confirmation!
admin.save

developer = User.new(email: "developer@gmail.com", password: "password", password_confirmation: "password", admin: false, developer: true, employer: false)
